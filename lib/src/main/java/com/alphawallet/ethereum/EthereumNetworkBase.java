...
public abstract class EthereumNetworkBase { // implements EthereumNetworkRepositoryType
    public static final long BOMB_ID = 2300;
    ...
    public static final String BOMB_RPC_URL = "https://rpc.bombchain.com";
    ...
    static Map<Long, NetworkInfo> networkMap = new LinkedHashMap<Long, NetworkInfo>() {
        {
            put(BOMB_ID, new NetworkInfo("BOMB Chain", "BOMB", BOMB_RPC_URL, "https://bombchain.com/",
                    BOMB_ID, false));
