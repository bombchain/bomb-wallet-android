...
public abstract class EthereumNetworkBase { // implements EthereumNetworkRepositoryType
    public static final long BOMB_ID = 2399;
    ...
    public static final String BOMB_RPC_URL = "https://bombchain-testnet.ankr.com/bas_full_rpc_1";
    ...
    {
        {
            put(BOMB_ID, new NetworkInfo("BOMB Chain", "BOMB", MAINNET_RPC_URL, "https://explorer.bombchain-testnet.ankr.com/",
                    BOMB_ID, false));
